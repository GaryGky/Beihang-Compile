...
#ifndef CODEGENPROEJCT_ERRORLEXICALPARSER_H
#define CODEGENPROEJCT_ERRORLEXICALPARSER_H
...
public:
    explicit ErrorLexicalParser(ErrorParse &errorParse1);
